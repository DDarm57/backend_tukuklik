@extends('layouts.dashboard.app', ['title' => 'Tambah Banner'])
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @enderror
                                    <small class="font-xs text-muted">Rekomendasi : 1200 x 350 px </small>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{ old('position') }}" name="position" class="form-control @error('position') is-invalid @enderror">
                                    @error('position')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
