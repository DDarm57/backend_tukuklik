@extends('layouts.dashboard.app', ['title' => 'Tambah Produk'])
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="product_sku" class="form-control" placeholder="SKU Number...">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="minimum_order_qty" class="form-control" placeholder="Minimal Order...">          
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="max_order_qty" class="form-control" placeholder="Maksimal Order...">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea id="description" class="form-control w-100" name="description" rows="100" cols="50"></textarea>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="text" name="tags" class="form-control" placeholder="Tag Product..." data-role="tagsinput">
                                        ...
                                        <div id="selectVarian" style="display:none" class="col-lg-12">
                                        </div>
                                        <div id="tableVarian" style="display:none" class="form-group col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                        <input type="text" name="weight" placeholder="Berat..." class="form-control"> 
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                        <input type="text" name="length" placeholder="Panjang..." class="form-control"> 
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                        <input type="text" name="breadth" placeholder="Lebar..." class="form-control"> 
                                                        <span class="input-group-text" id="basic-addon2">cm</span>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                        <input type="text" name="height" placeholder="Tinggi..." class="form-control"> 
                                                        <span class="input-group-text" id="basic-addon2">cm</span>
                                        ...
                                        <div class="form-group col-lg-12">
                                            <div class="row">
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <input type="text" name="product_stock" class="form-control" placeholder="Stok...">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <input type="text" name="discount" class="form-control" placeholder="Diskon...">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                        ...
                                                        <input type="text" name="selling_price" id="rupiah" placeholder="Harga..." class="form-control">
                                                        <span id="message_selling_price" class="invalid-feedback" style="display:none">
                                                        </span>
                                                    </div>
                                                    <div class="form-check"> 
                                                        <input class="form-check-input" type="checkbox" id="gridCheck1" name="has_wholesale"> 
                                                        <label class="form-check-label" for="gridCheck1">Produk Ini Memiliki Harga Grosir</label>
                                                    </div>
                                                </div>
                                                <div id="buttonWholesale" class="col-lg-12" style="display:none">
                                                    <a class="btn btn-outline-danger" id="addWholesale">Tambah</a>
                                                </div>
                                                <div class="col-lg-12" id="wholesale" style="display:none">
                                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <div class="input-group mb-3"> 
                                                        <input type="number" name="processing_estimation" value=1 class="form-control">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <input type="text" name="video_link" class="form-control" placeholder="Link Video...">
                    ...
                    <div class="card">
                        <div class="card-body> p-3">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-2">
                                    <input type="hidden" value="product" name="product_type">
                                    <a onclick="saveForm()" class="btn btn-outline-danger btn-md w-100 submit"><i class="bi bi-save"></i> Simpan</a>
                                </div>
                            </div>
                        </div>
                    </div>
