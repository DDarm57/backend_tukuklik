            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @can('product.category_create')
                            <a href="{{ url('dashboard/category/create') }}" class="btn btn-outline-danger mt-2 mb-4"><i class="bi bi-plus-circle"></i> Tambah Kategori</a>
                        @endcan
            ...
            columns: [
                ...
                },
                {
                    ...
                    mRender: function(data) {
                        ...
                        $opsiHtml += '@can("product.category_update")<li><a class="dropdown-item" href="{{ url("dashboard/category") }}/'+data.id+'/edit">Update</a></li>@endcan';
                        $opsiHtml += '@can("product.category_delete")<li><a class="dropdown-item" onclick="deleted('+data.id+')" href="#">Delete</a></li>@endcan';
                        $opsiHtml += '</ul>';
                        return $opsiHtml;
                    }
                },
