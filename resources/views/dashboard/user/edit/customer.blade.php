@extends('layouts.dashboard.app', ['title' => 'Create Customer'])
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('name') ?? $customer->name }}" name="name" class="form-control @error('name') is-invalid @enderror " placeholder="Customer name...">
                                            @error('name')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('email') ?? $customer->email }}" name="email" class="form-control @error('email') is-invalid @enderror " placeholder="Email...">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('phone_number') ?? $customer->phone_number }}" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror " placeholder="Phone Number...">
                                            @error('phone_number')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" value="{{ old('date_of_birth') ?? $customer->date_of_birth }}" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror " placeholder="Date Of Birth...">
                                            @error('date_of_birth')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control selects @error('is_actived') is-invalid @enderror" name="is_actived">
                                                <option></option>
                                                <option value="Y" {{ old('is_actived') == 'Y' ? 'selected' : ($customer->is_actived == 'Y' ? 'selected' : '') }}>Ya</option>
                                                <option value="T" {{ old('is_actived') == 'T' ? 'selected' : ($customer->is_actived == 'T' ? 'selected' : '') }}>Tidak</option>
                                            </select>
                                            @error('is_actived')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
