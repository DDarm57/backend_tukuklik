@extends('layouts.dashboard.app', ['title' => 'Create Staff'])
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ old('name') }}" name="name" class="form-control @error('name') is-invalid @enderror " placeholder="Staff name...">
                                            @error('name')
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control selects @error('organization_id') is-invalid @enderror" name="organization_id">
                                                ...
                                                @foreach ($organization as $org)
                                                    <option value="{{ $org->id }}" {{ old('organization_id') == $org->id ? 'selected' : '' }}>{{ $org->org_name }}</option>
                                                @endforeach
                                            </select>
