							...
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
								...
								<tr>
									...
									<div class="mktEditable" id="main_text">
										Hello {{ $user->name }},
                                        <p>Terima kasih telah mendaftar di marketplace Tukuklik. Berikut kami sampaikan link verifikasi.
                                        Batas Waktu Verifikasi Sampai {{ $validUntil }} </p>
									</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<div class="mktEditable" id="download_button" style="text-align: center;">
										<a href="{{ $link }}" style="color:#ffffff; background-color: #ff8300; border: 20px solid #ff8300; border-left: 20px solid #ff8300; border-right: 20px solid #ff8300; border-top: 10px solid #ff8300; border-bottom: 10px solid #ff8300;border-radius: 3px; text-decoration:none;" href="#">Verifikasi Sekarang</a>										
									</div>
									</td>
								</tr>
							</table>
